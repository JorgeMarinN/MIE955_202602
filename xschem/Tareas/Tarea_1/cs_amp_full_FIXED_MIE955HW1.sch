...
N 4200 -600 4200 -580 {
lab=GND}
N 4010 -690 4010 -600 {lab=vg}
N 4010 -600 4080 -600 {lab=vg}
N 3840 -690 3840 -600 {lab=#net1}
N 3840 -540 4160 -540 {lab=GND}
N 4160 -550 4160 -540 {
lab=GND}
N 3900 -690 4010 -690 {lab=vg}
...
C {devices/isource.sym} 4160 -790 0 0 {name=I1 value=157u}
C {devices/vdd.sym} 4160 -880 0 0 {name=l4 lab=VDD}
C {devices/iopin.sym} 4230 -760 0 0 {name=p6 lab=vout}
C {sg13g2_pr/sg13_lv_nmos.sym} 4140 -600 0 0 {name=M1
l=0.45u
w=47u
ng=10
m=1
...
C {devices/code_shown.sym} 2730 -800 0 0 {name=MODEL1 only_toplevel=true
...
.endif
"}
C {bsource.sym} 3840 -570 0 0 {name=B1 VAR=V FUNC="0.6*(1+tanh(10000*(v(vfb)-v(vref))))"}
C {vsource.sym} 3870 -690 1 0 {name=V1 value="dc 0 ac 1" savecurrent=false}
